...
from .views import (ProductList, sales_factura_report,
                    ...
                    viewsale, total_sales_without_sb_report)
...
urlpatterns = [
    ...
    path('reports/sales/no-factura/',
         sales_sin_factura_report, name='sales_sin_factura'),
    path('reports/sales/totals/', total_sales_report, name='sales_total'),
    path('reports/sales/without-sb/', total_sales_without_sb_report,
         name='sales_total_without_sb'),
    path('reports/sales/products/', total_sales_product_report,
         name='sales_products_total'),
    path('reports/sales/vendor/<str:vendor>/',
         sales_vendor_report, name='sales_vendor'),
